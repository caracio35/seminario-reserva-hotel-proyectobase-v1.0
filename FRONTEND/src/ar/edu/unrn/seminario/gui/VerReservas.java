...
public class VerReservas extends JFrame {
	...
	public VerReservas(IApi api, Locale idioma) throws CampoVacioExeption, EnterosEnCeroExeption, PrecioCeroExeption {
		...
		DefaultTableModel model = new DefaultTableModel(new Object[][] {},
				new String[] { recursos.getString("reservas.idReserva"), recursos.getString("reservas.numHabitaciones"),
						recursos.getString("reservas.checkIn"), recursos.getString("reservas.ingreso"),
						recursos.getString("reservas.checkOut"), recursos.getString("reservas.ingreso"),
						recursos.getString("reservas.calificacion"), recursos.getString("reservas.servicios") }) {
			@Override
	...
	private String numeroDehabitaciones(int[] numHabitaciones) {
		...
		return Arrays.stream(numHabitaciones).mapToObj(String::valueOf).collect(Collectors.joining(", "));
	}
}